...
class Application_Form_WeaponFilter extends Zend_Form
{
    ...
    public function init()
    {
        ...
        $this->addElement('select', 'filter_training', 
            array(
                'label'      => 'Training:',
                'required'   => false,
        ...
        $this->addElement('select', 'filter_reach', 
            array(
                'label'      => 'Reach:',
                'required'   => false,
        ...
        $this->addElement('select', 'filter_reachsub', 
            array(
                'label'      => 'Reachsub:',
                'required'   => false,
        ...
        $this->addElement('select', 'filter_encumbrance', 
            array(
                'label'      => 'Encumbrance:',
                'required'   => false,
